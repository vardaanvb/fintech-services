...
public class ExcelToJSONBody {
	...
	public HashMap<String, Object> fundsTransferDataFromExcel(String testcaseName, String sheetName) {

		
		String amountValue  = ex.getData(testcaseName, JSONToExcelMapper.FundsTransfer.AMOUNT.getJsonKey(),  sheetName);
		String currencyValue  = ex.getData(testcaseName, JSONToExcelMapper.FundsTransfer.CURRENCY.getJsonKey(),  sheetName);
		String fromAccount  = ex.getData(testcaseName, JSONToExcelMapper.FundsTransfer.FROM_ACCOUNT.getJsonKey(),  sheetName);
		String toAccount  = ex.getData(testcaseName, JSONToExcelMapper.FundsTransfer.TO_ACCOUNT.getJsonKey(),  sheetName);
